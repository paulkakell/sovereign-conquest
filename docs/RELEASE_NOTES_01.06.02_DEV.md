# Sovereign Conquest v01.06.02 Development Release
...
## Fixes
- Align application, browser, test, documentation, and release-facing version badges at `v01.06.02`.
...
- Remove proxy-derived client network addresses from persistent request logs while retaining transient rate-limiting behavior.
...
## Compatibility
- No stable tag or `main` branch publication occurs before merge approval.
...
- CodeQL log-privacy fix: `e9e49bce495c5f7619063b9305cda2b9caaf9b3e`
