...
- Replace the inactivity-disabled legacy Docker workflow with an active GHCR publisher.
...
- Scan the published image for high and critical vulnerabilities and publish provenance attestation.
...
- Publish `main`, `01.06.03`, and source-SHA GHCR tags, then smoke-test the pushed version image.
...
Refs
- SC-DEPLOY-003, SC-CI-012, SC-REPO-001, SC-REL-013
